...
`,k=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let b=m.bq.CONVERT_SLIPPAGE_TOLERANCE,f=class extends i.oi{constructor(){super(),this.unsubscribe=[],this.networkName=a.R.state.activeCaipNetwork?.name,this.detailsOpen=!1,this.sourceToken=l.nY.state.sourceToken,this.toToken=l.nY.state.toToken,this.toTokenAmount=l.nY.state.toTokenAmount,this.sourceTokenPriceInUSD=l.nY.state.sourceTokenPriceInUSD,this.toTokenPriceInUSD=l.nY.state.toTokenPriceInUSD,this.priceImpact=l.nY.state.priceImpact,this.maxSlippage=l.nY.state.maxSlippage,this.networkTokenSymbol=l.nY.state.networkTokenSymbol,this.inputError=l.nY.state.inputError,this.unsubscribe.push(l.nY.subscribe(e=>{this.sourceToken=e.sourceToken,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.priceImpact=e.priceImpact,this.maxSlippage=e.maxSlippage,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError}))}render(){let e=this.toTokenAmount&&this.maxSlippage?r.C.bigNumber(this.toTokenAmount).minus(this.maxSlippage).toString():null;if(!this.sourceToken||!this.toToken||this.inputError)return null;let t=this.sourceTokenPriceInUSD&&this.toTokenPriceInUSD?1/this.toTokenPriceInUSD*this.sourceTokenPriceInUSD:0;return(0,i.dy)`
    ...
    `}toggleDetails(){this.detailsOpen=!this.detailsOpen}};f.styles=[w],k([(0,n.SB)()],f.prototype,"networkName",void 0),k([(0,n.Cb)()],f.prototype,"detailsOpen",void 0),k([(0,n.SB)()],f.prototype,"sourceToken",void 0),k([(0,n.SB)()],f.prototype,"toToken",void 0),k([(0,n.SB)()],f.prototype,"toTokenAmount",void 0),k([(0,n.SB)()],f.prototype,"sourceTokenPriceInUSD",void 0),k([(0,n.SB)()],f.prototype,"toTokenPriceInUSD",void 0),k([(0,n.SB)()],f.prototype,"priceImpact",void 0),k([(0,n.SB)()],f.prototype,"maxSlippage",void 0),k([(0,n.SB)()],f.prototype,"networkTokenSymbol",void 0),k([(0,n.SB)()],f.prototype,"inputError",void 0),f=k([(0,h.Mo)("w3m-swap-details")],f),o(80843);var x=(0,h.iv)`
  :host {
    width: 100%;
  }
...
`,I=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let A=class extends i.oi{subscribe({resetSwapState:e,initializeSwapState:t}){return()=>{a.R.subscribeKey("activeCaipNetwork",o=>this.onCaipNetworkChange({newCaipNetwork:o,resetSwapState:e,initializeSwapState:t})),a.R.subscribeChainProp("accountState",o=>{this.onCaipAddressChange({newCaipAddress:o?.caipAddress,resetSwapState:e,initializeSwapState:t})})}}constructor(){super(),this.unsubscribe=[],this.initialParams=s.RouterController.state.data?.swap,this.detailsOpen=!1,this.caipAddress=a.R.getAccountData()?.caipAddress,this.caipNetworkId=a.R.state.activeCaipNetwork?.caipNetworkId,this.initialized=l.nY.state.initialized,this.loadingQuote=l.nY.state.loadingQuote,this.loadingPrices=l.nY.state.loadingPrices,this.loadingTransaction=l.nY.state.loadingTransaction,this.sourceToken=l.nY.state.sourceToken,this.sourceTokenAmount=l.nY.state.sourceTokenAmount,this.sourceTokenPriceInUSD=l.nY.state.sourceTokenPriceInUSD,this.toToken=l.nY.state.toToken,this.toTokenAmount=l.nY.state.toTokenAmount,this.toTokenPriceInUSD=l.nY.state.toTokenPriceInUSD,this.inputError=l.nY.state.inputError,this.fetchError=l.nY.state.fetchError,this.lastTokenPriceUpdate=0,this.minTokenPriceUpdateInterval=1e4,this.visibilityChangeHandler=()=>{document?.hidden?(clearInterval(this.interval),this.interval=void 0):this.startTokenPriceInterval()},this.startTokenPriceInterval=()=>{this.interval&&Date.now()-this.lastTokenPriceUpdate<this.minTokenPriceUpdateInterval||(this.lastTokenPriceUpdate&&Date.now()-this.lastTokenPriceUpdate>this.minTokenPriceUpdateInterval&&this.fetchTokensAndValues(),clearInterval(this.interval),this.interval=setInterval(()=>{this.fetchTokensAndValues()},this.minTokenPriceUpdateInterval))},this.watchTokensAndValues=()=>{this.sourceToken&&this.toToken&&(this.subscribeToVisibilityChange(),this.startTokenPriceInterval())},this.onDebouncedGetSwapCalldata=u.j.debounce(async()=>{await l.nY.swapTokens()},200),this.subscribe({resetSwapState:!0,initializeSwapState:!1})(),this.unsubscribe.push(this.subscribe({resetSwapState:!1,initializeSwapState:!0}),c.I.subscribeKey("open",e=>{e||l.nY.resetState()}),s.RouterController.subscribeKey("view",e=>{e.includes("Swap")||l.nY.resetValues()}),l.nY.subscribe(e=>{this.initialized=e.initialized,this.loadingQuote=e.loadingQuote,this.loadingPrices=e.loadingPrices,this.loadingTransaction=e.loadingTransaction,this.sourceToken=e.sourceToken,this.sourceTokenAmount=e.sourceTokenAmount,this.sourceTokenPriceInUSD=e.sourceTokenPriceInUSD,this.toToken=e.toToken,this.toTokenAmount=e.toTokenAmount,this.toTokenPriceInUSD=e.toTokenPriceInUSD,this.inputError=e.inputError,this.fetchError=e.fetchError,e.sourceToken&&e.toToken&&this.watchTokensAndValues()}))}async firstUpdated(){l.nY.initializeState(),this.watchTokensAndValues(),await this.handleSwapParameters()}disconnectedCallback(){this.unsubscribe.forEach(e=>e?.()),clearInterval(this.interval),document?.removeEventListener("visibilitychange",this.visibilityChangeHandler)}render(){return(0,i.dy)`
    ...
    ></w3m-swap-input>`}onSetMaxValue(e,t){let o=r.C.bigNumber(t||"0");if(!o.gt(0)){this.handleChangeAmount(e,"0");return}let i="sourceToken"===e?this.sourceToken:this.toToken,n=i?.decimals??18,{networkAddress:a}=l.nY.getParams(),s=l.nY.state.gasFee;if("sourceToken"===e&&i?.address===a&&s&&"0"!==s){let t=150000n*BigInt(s),i=r.C.bigNumber(t.toString()).div(r.C.bigNumber(10).pow(n)),a=o.minus(i);this.handleChangeAmount(e,a.gt(0)?a.toFixed(n,0):"0")}else this.handleChangeAmount(e,o.toFixed(n,0))}templateDetails(){return this.sourceToken&&this.toToken&&!this.inputError?(0,i.dy)`<w3m-swap-details .detailsOpen=${this.detailsOpen}></w3m-swap-details>`:null}handleChangeAmount(e,t){l.nY.clearError(),"sourceToken"===e?l.nY.setSourceTokenAmount(t):l.nY.setToTokenAmount(t),this.onDebouncedGetSwapCalldata()}templateActionButton(){let e=!this.toToken||!this.sourceToken,t=!this.sourceTokenAmount||"0"===this.sourceTokenAmount,o=this.loadingQuote||this.loadingPrices||this.loadingTransaction,n=o||e||t||this.inputError;return(0,i.dy)` <wui-flex gap="2">
      <wui-button
...
`,U=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let O=class extends i.oi{constructor(){super(),this.observer=new IntersectionObserver(()=>void 0),this.imageSrc=void 0,this.name=void 0,this.symbol=void 0,this.price=void 0,this.amount=void 0,this.visible=!1,this.imageError=!1,this.observer=new IntersectionObserver(e=>{e.forEach(e=>{e.isIntersecting?this.visible=!0:this.visible=!1})},{threshold:.1})}firstUpdated(){this.observer.observe(this)}disconnectedCallback(){this.observer.disconnect()}render(){if(!this.visible)return null;let e=this.amount&&this.price?r.C.multiply(this.price,this.amount)?.toFixed(3):null;return(0,i.dy)`
    ...
    `}visualTemplate(){return this.imageError?(0,i.dy)`<wui-flex class="token-item-image-placeholder">
      ...
      ></wui-image>`:null}imageLoadError(){this.imageError=!0}};O.styles=[R.ET,R.ZM,L],U([(0,n.Cb)()],O.prototype,"imageSrc",void 0),U([(0,n.Cb)()],O.prototype,"name",void 0),U([(0,n.Cb)()],O.prototype,"symbol",void 0),U([(0,n.Cb)()],O.prototype,"price",void 0),U([(0,n.Cb)()],O.prototype,"amount",void 0),U([(0,n.SB)()],O.prototype,"visible",void 0),U([(0,n.SB)()],O.prototype,"imageError",void 0),O=U([(0,E.M)("wui-token-list-item")],O),o(42653);var N=(0,j.iv)`
  :host {
    width: 100%;
  }
...
`;let z=class extends i.oi{render(){return(0,i.dy)`
    ...
    `}};z.styles=[R.ET,N],z=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a}([(0,E.M)("wui-token-list-item-loader")],z);var V=(0,h.iv)`
  :host {
...
`,u=function(e,t,o,i){var n,r=arguments.length,a=r<3?t:null===i?i=Object.getOwnPropertyDescriptor(t,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)a=Reflect.decorate(e,t,o,i);else for(var s=e.length-1;s>=0;s--)(n=e[s])&&(a=(r<3?n(a):r>3?n(t,o,a):n(t,o))||a);return r>3&&a&&Object.defineProperty(t,o,a),a};let c={lg:"lg-regular",md:"lg-regular",sm:"md-regular"},d={lg:"lg",md:"md",sm:"sm"},p=class extends i.oi{constructor(){super(...arguments),this.size="md",this.disabled=!1,this.text="",this.loading=!1}render(){return this.loading?(0,i.dy)` <wui-flex alignItems="center" gap="01" padding="01">
    ...
    `}imageTemplate(){if(this.imageSrc&&this.chainImageSrc)return(0,i.dy)`<wui-flex class="left-image-container">
      ...
      >${this.text}</wui-text
    >`}};p.styles=[r.ET,r.ZM,l],u([(0,n.Cb)()],p.prototype,"size",void 0),u([(0,n.Cb)()],p.prototype,"imageSrc",void 0),u([(0,n.Cb)()],p.prototype,"chainImageSrc",void 0),u([(0,n.Cb)({type:Boolean})],p.prototype,"disabled",void 0),u([(0,n.Cb)()],p.prototype,"text",void 0),u([(0,n.Cb)({type:Boolean})],p.prototype,"loading",void 0),u([(0,a.M)("wui-token-button")],p)}}]);